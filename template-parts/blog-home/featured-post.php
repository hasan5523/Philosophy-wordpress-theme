                            ...
                            <div class="entry__content">
                                ...
                                <div class="entry__info">
                                    <a href="#0" class="entry__profile-pic">
                                        <img class="avatar" src="<?php echo esc_url($post_data[0]['author_avater']);?>" alt="<?php echo esc_html($post_data[0]['title']);?>">
                                    </a>
                    ...
                    ?>
                        ...
                        <div class="entry" style="background-image:url('<?php echo esc_url($post_data[$i]['thumbnail']) ?>');">
                            ...
                            <div class="entry__content">
                                ...
                                <div class="entry__info">
                                    <a href="#0" class="entry__profile-pic">
                                        <img class="avatar" src="<?php echo esc_url($post_data[$i]['author_avater']);?>" alt="<?php echo esc_html($post_data[$i]['title']);?>">
                                    </a>
