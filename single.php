                ...
                <?php echo get_avatar( get_the_author_meta('ID'));?>
                    ...
                    <div class="s-content__author-about">
                        ...
                        <?php 
                            ...
                            $philosophy_user_linkedin = get_field('linkedin',"user_".get_the_author_meta('ID'));
                        ?>

                        <ul class="s-content__author-social">
                        <?php if($philosophy_user_facebook ): ?>
                                <li><a href="<?php echo esc_url($philosophy_user_facebook)?>" target="_blank">Facebook</a></li>
                        <?php endif;?>

                        <?php  if($philosophy_user_twitter ): ?>
                                <li><a href="<?php echo esc_url($philosophy_user_twitter)?>" target="_blank">Twitter</a></li>
                        <?php endif;?>

                        <?php if($philosophy_user_linkedin ): ?>
                                <li><a href="<?php echo esc_url($philosophy_user_linkedin)?>" target="_blank">LinkedIn</a></li>
                        <?php endif;?>
